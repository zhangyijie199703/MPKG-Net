...
def main(args, logger):
    ...
    model.load_state_dict(OrderedDict({k.replace('module.', ''): v for k, v in torch.load(
        '/home/jim/nas/zhangyijie/RS_SS/exp/uestc_journal/MFCNet1212/6/resnet50bs4gpu6/model_BestOA.pth').items()}))
...
if __name__ == '__main__':
    ...
    parser.add_argument('--savedir', default="/home/jim/nas/zhangyijie/RS_SS/exp/uestc_journal/test/mfcnet1212_3",
