...
# from model.FM_MFcollaboration.MFCNet1128 import Net as Net2
from compare_model.hrnet_w48 import HRNetV2W48 as Net2
...
from loader.load_potsdam_nob import vaihingenloader
...
def train(args, trainloader, model, criterion, boundary_loss, sobelx, sobely, criterion1, optimizer, epoch, logger):
    ...
    total_loss = 0.
    for iter, batch in enumerate(tqdm(trainloader, desc=f'Epoch {epoch + 1}/{args.max_epochs}')):
...
def main(args, logger):
    ...
    #
    # # 遍历backbone模块中的所有参数
    # for param in model.module.vit_l_rvsa.parameters():
    #     param.requires_grad = False
    #     # print("hold on")
    #
    # # for param in model.module.swinv2.parameters():
    # #     param.requires_grad = False
    # #     # print("hold on")
...
if __name__ == '__main__':
    ...
    parser.add_argument('--root', default='/media/data/zyj/P', help='data directory')  # /media/ssd2/zyj/data/V1
    parser.add_argument('--picsave', default="/home/jim/nas/zhangyijie/RS_SS/exp/tgrs_neo/p/final2/", help="directory to save result picture")
    parser.add_argument('--savedir', default="/home/jim/nas/zhangyijie/RS_SS/exp/tgrs_neo/p/final2/", help="directory to save the model snapshot")
    ...
    parser.add_argument('--lr', default= 0.00006, type=float) # 0.00003
    ...
    args = parser.parse_args() # 19113478254
    print('final2-potsdam')
    # run_id = '1'
    run_id = args.run_id
