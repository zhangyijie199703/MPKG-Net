...
# from model.FM_MFcollaboration.MFCNet import Net as Net2
...
def main(args, logger):
    ...
    model.load_state_dict(OrderedDict({k.replace('module.', ''): v for k, v in torch.load(
        '/home/jim/nas/zhangyijie/RS_SS/exp/tgrs_neo/p/final2/6/resnet50bs4gpu6/model_BestOA.pth').items()}))
...
if __name__ == '__main__':
    ...
    parser.add_argument('--root', default='/media/data/zyj/P', help='data directory')
    ...
    parser.add_argument('--savedir', default="/home/jim/nas/zhangyijie/RS_SS/exp/test_p/fina2_all",
