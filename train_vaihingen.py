...
if __name__ == '__main__':
    ...
    parser.add_argument('--root', default='/media/ssd/zhangyijie/GRSL2/rs_code/data/V1', help='data directory')  # /media/ssd2/zyj/data/V1
    parser.add_argument('--picsave', default="/home/jim/nas/zhangyijie/RS_SS/exp/uestc_journal/MFCNet1212", help="directory to save result picture")
    parser.add_argument('--savedir', default="/home/jim/nas/zhangyijie/RS_SS/exp/uestc_journal/MFCNet1212", help="directory to save the model snapshot")
